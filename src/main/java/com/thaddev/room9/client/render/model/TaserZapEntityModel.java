package com.thaddev.room9.client.render.model;
...
public class TaserZapEntityModel<T extends Entity> extends SinglePartEntityModel<T> {
    /**
    ...
    public TaserZapEntityModel(ModelPart root) {
        this.root = root;
    }
